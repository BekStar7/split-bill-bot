...
6. Под итогами — кнопки «Оплатил(а)» на каждого. Свою кнопку может нажать только тот человек, к которому она относится (или тот, кто загрузил чек); отменить отметку — только тот, кто загрузил чек. Список сразу перестраивается на «Оплатили» / «Должны».
